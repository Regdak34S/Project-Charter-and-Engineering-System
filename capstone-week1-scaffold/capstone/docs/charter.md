...
| Weeks that are already broken (and where those hours move) |Week 8 may be disrupted depending on whether there is a break or other commitments. I will move work to an earlier week if the disruption is confirmed. |
